...
import { Building2, Layers3, Hammer, Bath, MoveRight, Warehouse, PlugZap, Contact2, Droplets, ArrowRight, Star } from "lucide-react";
...
const services = [
  {
    ...
    features: ["Full property makeover", "Custom design solutions", "Project management"]
  },
  {
    ...
    features: ["Space optimization", "Natural light solutions", "Building regulations"]
  },
  {
  ...
  },
  {
    ...
    features: ["Luxury finishes", "Wet room solutions", "Accessibility options"]
  },
  {
    ...
    features: ["Planning permission", "Structural design", "Seamless integration"]
  },
  {
  ...
  },
  {
    ...
    features: ["Certified electricians", "Safety compliance", "Smart home systems"]
  },
  {
        ...
        <div className="text-center mb-20 relative">
          ...
          <div className="relative z-10">
            <div className="inline-flex items-center space-x-2 bg-[#CC3333]/10 px-4 py-2 rounded-full mb-6">
              ...
              <span className="text-sm font-semibold text-[#CC3333] uppercase tracking-wide">Premium Building Services</span>
            </div>
            ...
            <p className="text-xl md:text-2xl text-gray-600 max-w-4xl mx-auto leading-relaxed font-medium">
              Discover how <strong className="text-[#CC3333]">JRS Building Company</strong> transforms London homes and commercial properties through expert construction and renovation services.
            </p>
          </div>
        </div>
          ...
          {services.map((service, index) => (
            ...
            >
              ...
              <div className="relative z-10 p-8">
                ...
                <div className={`inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-gradient-to-r ${service.color} text-white mb-6 shadow-lg group-hover:scale-110 group-hover:rotate-3 transition-all duration-500`}>
                  {service.icon}
                </div>
        ...
        <section className="relative overflow-hidden bg-gradient-to-r from-[#CC3333] via-[#b62d2d] to-[#CC3333] py-16 px-8 rounded-3xl shadow-2xl">
          ...
          <div className="relative z-10 max-w-4xl mx-auto text-center text-white">
            ...
            <p className="text-xl md:text-2xl mb-10 leading-relaxed opacity-90 font-medium">
              Contact <strong>JRS Building Company</strong> today for a personalised quote and expert advice. We&apos;re ready to build your vision.
            </p>
